This application starts-up showing "Hello World!" and prompts the user to enter their name. Once the button is clicked, the text will display "Hi, [user input]." 
